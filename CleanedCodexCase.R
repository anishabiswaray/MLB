...
RM1 <- lm(formula = wins_prob ~  OverallOBP + OverallSLG + OverallSB + Overallk_9ip +OverallFieldP + OverallWhip + team_budget ,
          data = stats_model_1)
RM1
...
RM2 <- lm(formula = wins_prob ~ OverallBA + OverallOBP + OverallSLG +OverallSB + OverallFieldP + Overallk_9ip + OverallWhip + OverallFIP + team_budget, data = stats_model_2)
RM2
# to know summary statistics for the model
summary(RM2)
